            ...
            public void onClick(View view) {
                ...
                dbNameFechingRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange( DataSnapshot dataSnapshot) {
                        ...
                        StudentsAttendanceListSingleTone studentsAttendanceListSingleTone = StudentsAttendanceListSingleTone.getInstance();//new
                         studentsAttendanceListSingleTone.setStudentsAttendanceList("University/IUT/StudentsInSection",sec,crs);
                        studentsAttendanceListSingleTone.setStudentsAttendanceListPath(sec,crs,T_name);
