...
import com.example.iutassistant.Model.QuizInfo;
...
public class QuizDeclarationActivity extends AppCompatActivity {
    ...
    public void doneButton_action(){
       ...
       doneButton.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               ...
               {    Toast.makeText(QuizDeclarationActivity.this, "Please fill the form properly", Toast.LENGTH_SHORT).show();
               return;}
