...
public class ClassRescheduling_Adapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<AnnouncementDetail> announcementDetails;

    public ClassRescheduling_Adapter(Context mContext, ArrayList<AnnouncementDetail> announcementDetails) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        date_text_var.setText("Date");
        info_text.setText("Information");
        type_text.setText("Class Update");
        ...
        syllabus.setText(announcementDetails.get(i).getDescriptive_part());
